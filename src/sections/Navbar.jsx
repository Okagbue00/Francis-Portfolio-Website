...
function Navigation(){
    return (
        <ul className='nav-ul'>
            ...
            <li className='nav-li'><a className='nav-link' href='#experiences'>Work</a></li>
    ...
    <div className="fixed inset-x-0 z-20 w-full backdrop-blur-lg bg-primary/40">
        <div className="mx-auto c-space max-w-7xl">
            <div className="flex items-center justify-between py-2 sm:py-0">
                <a href="/" className="text-xl font-bold transition-colors text-neutral-400 hover:text-white">Francis</a>
